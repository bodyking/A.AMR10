   ...
   client.on("message", message => {
    if (message.content === "-help-m") {
     const embed = new Discord.RichEmbed() 
         .setThumbnail(message.author.avatarURL)
         .setColor("#00FF00")
        .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  hhttps://discord.gg/mPWmh7 :scroll: **`)
...
**  ======:blossom:نــتــمــنــآ لــكــم آســتــمـــتــآع :blossom:======  **`)
 ...
 .setTitle(`Welcome To ${msg.guild.name}`)
  ...
  .setURL('https://discordapp.com/oauth2/authorize?client_id=518119545148538950&permissions=8&scope=bot')
